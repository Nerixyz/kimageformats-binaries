...
if ($IsWindows) {
    ...
    brew tap-new "$Env:GITHUB_WORKSPACE/local-tap"
    brew tap homebrew/core --force
    brew extract --version=2.16.03 nasm "$Env:GITHUB_WORKSPACE/local-tap"
    brew install "$Env:GITHUB_WORKSPACE/local-tap/nasm@2.16.03"
